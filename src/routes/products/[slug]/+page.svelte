<script lang="ts">
	...
	const toggleDropdown = (index: number) => {
		if (openDropdowns[index]) {
			openDropdowns = new Array(productComments.length).fill(false);
		} else {
			openDropdowns = new Array(productComments.length).slice(index, 0).fill(false);
				...
				<div class="max-w-2xl mx-auto px-4">
						...
						<article class="p-6 mb-3 text-base bg-white rounded-lg dark:bg-gray-900 rounded-lg">
							<footer class="flex justify-between items-center mb-2">
								...
								<div
									...
									class:hidden={!openDropdowns[index]}
									class:block={openDropdowns[index]}
					...
					<article class="p-6 mb-3 ml-6 lg:ml-12 text-base bg-white rounded-lg dark:bg-gray-900">
						<footer class="flex justify-between items-center mb-2">
							...
							<button
								id="dropdownComment20Button"
								data-dropdown-toggle="dropdownComment20"
